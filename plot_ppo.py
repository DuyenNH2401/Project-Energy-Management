...
def plot_tianshou_metrics(csv_path, output_dir='reports/tianshou_ppo_plot_8_random'):
...
plot_tianshou_metrics('reports/tianshou_ppo/training_log_13032026_222442.csv')